...
export type Database = {
  ...
  public: {
    Tables: {
      job_status_history: {
        Row: {
          ...
          id: string
          job_id: string
          status: Database["public"]["Enums"]["wash_job_status"]
        }
        Insert: {
          changed_at?: string
          id?: string
      ...
      ratings: {
        Row: {
          ...
          id: string
          job_id: string
          rated_by: Database["public"]["Enums"]["user_role"]
      ...
      vehicles: {
        Row: {
          ...
          size_category: Database["public"]["Enums"]["vehicle_size_category"]
        }
        Insert: {
          color?: string | null
          id?: string
      ...
      wash_jobs: {
        ...
        Relationships: [
          {
            foreignKeyName: "wash_jobs_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "wash_jobs_vehicle_id_fkey"
            columns: ["vehicle_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "wash_jobs_washer_id_fkey"
            columns: ["washer_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      washer_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "washer_profiles_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "users"
            referencedColumns: ["id"]
    ...
    Enums: {
      user_role: "owner" | "washer"
      vehicle_size_category: "compact" | "sedan" | "suv" | "truck"
      wash_job_status:
        | "requested"
        | "accepted"
        | "en_route"
